...
sap.ui.define([
...
], function (ManagedObject, XLSX) {
    'use strict';
    const SheetHandler = ManagedObject.extend('cc.spreadsheetimporter.v0_26_1.SheetHandler', {
        constructor: function _constructor() {
            ManagedObject.prototype.constructor.call(this);
        }
    });
    SheetHandler.sheet_to_json = function sheet_to_json(sheet, opts) {
    ...
    SheetHandler.make_json_row = function make_json_row(sheet, r, R, cols, header, hdr, o) {
    ...
    SheetHandler.safe_decode_range = function safe_decode_range(range) {
        var o = {
            s: {
                c: 0,
                r: 0
    ...
    SheetHandler.renameAttributes = function renameAttributes(dataArray) {
