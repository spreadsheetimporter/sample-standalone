...
import { $UIComponentSettings } from "sap/ui/core/UIComponent";
    ...
    export default interface Component {
        ...
        /**
         * Gets current value of property "readAllSheets".
         *
         * Default value is: false
         * @returns Value of property "readAllSheets"
         */
        getReadAllSheets(): boolean;

        /**
         * Sets a new value for property "readAllSheets".
         *
         * When called with a value of "null" or "undefined", the default value of the property will be restored.
         *
         * Default value is: false
         * @param [readAllSheets=false] New value for property "readAllSheets"
         * @returns Reference to "this" in order to allow method chaining
         */
        ...
        /**
         * Gets current value of property "componentContainerData".
         *
         * @returns Value of property "componentContainerData"
         */
        getComponentContainerData(): object;

        /**
         * Sets a new value for property "componentContainerData".
         *
         * When called with a value of "null" or "undefined", the default value of the property will be restored.
         *
         * @param componentContainerData New value for property "componentContainerData"
         * @returns Reference to "this" in order to allow method chaining
         */
         ...
         * @param parameters Parameters to pass along with the event
         * @param [mParameters.payload]
         * @param [mParameters.rawData]
         * @param [mParameters.parsedData]
         *
